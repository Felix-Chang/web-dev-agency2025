    ...
    <div className="min-h-screen bg-[#F8F8FF] font-sans dark:bg-[1B1B1B]">
      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center gap-6 px-4 py-16 overflow-hidden">
        ...
        <video
          ...
          muted
          playsInline
          className="absolute top-0 left-0 w-full h-full object-cover opacity-50 dark:opacity-30 z-0"
        >
        ...
        <div className="relative z-10 flex flex-col items-center gap-4 text-center max-w-4xl px-2">
          ...
          <p className="max-w-2xl text-lg leading-7 text-zinc-800 dark:text-zinc-400">
            High-performing websites and full-stack web apps designed to look
            great, load fast, and convert
          </p>
        </div>
        <Link
          className="relative z-10 flex h-11 items-center font-bold justify-center rounded-full bg-foreground px-6 text-sm text-background transition-colors hover:underline hover:bg-[#383838] dark:hover:bg-[#ccc]"
          href="/clients"
        >
          View Our Work
        </Link>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4">
              <h2 className="text-3xl font-bold text-black dark:text-zinc-50 leading-tight">
                Everything you need to launch and scale online.
              </h2>
              <p className="text-base leading-7 text-zinc-800 dark:text-zinc-400">
            ...
            <div className="flex items-center justify-center">
              <div className="w-full h-64 rounded-xl overflow-hidden bg-gradient-to-br from-zinc-100 to-zinc-200 dark:from-zinc-800 dark:to-zinc-900">
                <BuildLaunchScale />
              </div>
            </div>
          </div>
      ...
      <div className="pb-8 px-4">
        ...
        <div className="flex justify-center mt-8">
          <Link
            href="/services"
            className="flex h-11 items-center font-bold justify-center rounded-full bg-foreground px-6 text-sm text-background transition-colors hover:bg-[#383838] hover:underline dark:hover:bg-[#ccc]"
          >
            View All Services
          </Link>
        </div>
