    ...
    <div className="min-h-screen bg-[#F8F8FF] font-sans dark:bg-[1B1B1B]">
      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center gap-8 px-6 py-24 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-8 text-center max-w-4xl px-2">
          <h1 className="text-6xl font-bold tracking-tight text-black dark:text-zinc-50 leading-tight">
        ...
        <Link
          className="relative z-10 flex h-12 items-center font-bold justify-center rounded-full bg-foreground px-8 text-base text-background transition-colors hover:underline hover:bg-[#383838] dark:hover:bg-[#ccc]"
          href="/clients"
        >
          View Our Work
        </Link>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-2 gap-20 items-center">
            ...
            <div className="flex flex-col gap-6">
              <h2 className="text-5xl font-bold text-black dark:text-zinc-50 leading-tight">
      ...
      <div className="pb-12 px-6">
        ...
        <div className="flex justify-center mt-16">
          <Link
            href="/services"
            className="flex h-12 items-center font-bold justify-center rounded-full bg-foreground px-8 text-base text-background transition-colors hover:bg-[#383838] hover:underline dark:hover:bg-[#ccc]"
          >
            View All Services
          </Link>
        </div>
